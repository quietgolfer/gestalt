...
describe('ClassicGrid > Cache invalidation', () => {
  it('Able to invalidate cache', async () => {
    ...
    for (let i = 0; i < beforeReflowGridItems.length; i += 1) {
      ...
      beforeReflowItemLeftMap[itemRect.left] = beforeReflowItemLeftMap[itemRect.left] || [];
    ...
    for (let i = 0; i < afterReflowGridItems.length; i += 1) {
      ...
      afterReflowItemLeftMap[itemRect.left] = afterReflowItemLeftMap[itemRect.left] || [];
