...
RUN curl -sS https://dl.yarnpkg.com/debian/pubkey.gpg | apt-key add - && \
    ...
    echo "deb http://mozilla.debian.net/ jessie-backports firefox-esr" > /etc/apt/sources.list.d/debian-mozilla.list && \
    ...
    apt-get install --target-release jessie-backports firefox-esr -yy -qq && \
